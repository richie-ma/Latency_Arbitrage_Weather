...
## Market Data
In this section I detail my data sources. We use four data sources that offer precipitation and market data for the period from 2018 to 2019, the National Oceanic and Atmospheric Administration (NOAA), the New York Stock Exchange (NYSE) Daily Trade and Quote (DTAQ) data, the CME Market by Price data, and Bloomberg.   
